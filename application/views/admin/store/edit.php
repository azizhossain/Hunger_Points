            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('o_hr') != "") ? 'is-invalid' : '';?>" data-placeholder="Choose a Category">
                        ...
                        <option value="7am" <?php echo $store['o_hr'] == "7am" ? "selected" : "";?>>7am</option>
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('c_hr') != "") ? 'is-invalid' : '';?>" data-placeholder="Choose a Category">
                        ...
                        <option value="9pm" <?php echo $store['c_hr'] == "9pm" ? "selected" : "";?>>9pm</option>
                        <option value="10pm" <?php echo $store['c_hr'] == "10pm" ? "selected" : "";?>>10pm</option>
                        <option value="11pm" <?php echo $store['c_hr'] == "11pm" ? "selected" : "";?>>11pm</option>
                        <option value="12am" <?php echo $store['c_hr'] == "12am" ? "selected" : "";?>>12am</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('o_days') != "") ? 'is-invalid' : '';?>" data-placeholder="Choose a Category"
                        ...
                        <option value="Sat-Thu <?php echo $store['o_days'] == "Sat-Thu" ? "selected" : "";?>">Sat-Thu</option>
                        <option value="Sun-Thu" <?php echo $store['o_days'] == "Sun-Thu" ? "selected" : "";?>>Sun-Thu</option>
                        <option value="Fri" <?php echo $store['o_days'] == "Fri" ? "selected" : "";?>>Fri</option>
