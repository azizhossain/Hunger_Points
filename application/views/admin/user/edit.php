<div class="conatiner">
    ...
    <form action="<?php echo base_url().'admin/user/edit/'.$user['user_id']; ?>" method="POST"
        ...
        <h3 class="mb-3 p-2 text-center">Edit User "<?php echo $user['usersname']; ?>"</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="usersname">Enter Usersname</label>
                    <input type="text" id="usersname" class="form-control
                    <?php echo (form_error('usersname') != "") ? 'is-invalid' : '';?>" name="usersname"
