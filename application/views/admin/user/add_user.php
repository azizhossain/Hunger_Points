<div class="conatiner">
    ...
    <form action="<?php echo base_url().'admin/user/create_user'; ?>" method="POST"
        class="form-container mx-auto shadow-container" style="width:70% ; height: 100%;" id="myForm">
        <center>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="usersname">Enter usersname</label>
                    <input type="text" class="form-control
                    <?php echo (form_error('usersname') != "") ? 'is-invalid' : '';?>" name="usersname" id="usersname"
                        placeholder="Enter usersname" value="<?php echo set_value('usersname')?>">
        ...
        <div class="form-group">
            ...
            <textarea name="address" type="text" style="height:60px;" id="address" class="form-control
...
const validate = () => {
    const usersnameVal = usersname.value.trim();
    ...
    //usersname validation
    if (usersnameVal === "") {
        setErrorMsg(usersname, 'usersname cannot be blank');
    } else if (usersnameVal.length <= 4 || usersnameVal.length >= 16) {
        setErrorMsg(usersname, 'usersname length should be between 5 and 15"');
    } else if (!isNaN(usersnameVal)) {
        setErrorMsg(usersname, 'only characters are allowed');
    } else {
