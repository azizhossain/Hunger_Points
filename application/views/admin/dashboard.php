...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            <div class="card shadow p-30"  style="background: #ecc6c6;">
                <div class="media">
        ...
        <div class="col-md-3">
            <div class="card shadow p-30" style="background: #d1d1e0;">
                <div class="media">
                    <div class="media-left meida media-middle">
        ...
        <div class="col-md-3">
            <div class="card shadow p-30" style="background: #ffff99;">
                <div class="media">
                    <div class="media-left meida media-middle">
        ...
        <div class="col-md-3">
            <div class="card shadow p-30" style="background: #99ccff;">
                <div class="media">
                    <div class="media-left meida media-middle">
        ...
        <div class="col-md-3">
            <div class="card shadow p-30" style="background: #99ff99;">
                <div class="media">
                    <div class="media-left meida media-middle">
